...
function CookieAgree() {
  document.getElementById("cookie").classList.toggle("cookie2");
}
...
function ani() {
  document.getElementById("login-form").style.WebkitAnimationPlayState =
    "running";
}
function ani1() {
  document.getElementById("reg-form").style.WebkitAnimationPlayState =
    "running";
}
